...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://us.princesspolly.com/cart/39717008277588:1?traffic_source=buy_now');
...
$checkouts = trim(strip_tags(getstr($r1, 'pageurl":"us.princesspolly.com\/6186270804\/checkouts\/', '?')));
